/mob/living/human/proc/nomads_spawn()
	...
	if (map && (/*map.ID == MAP_NOMADS_CONTINENTAL || map.ID == MAP_NOMADS_PANGEA || */map.ID == MAP_NOMADS_NEW_WORLD))
		...
		r_hair = hex2num(copytext_char(hex_hair, 2, 4))
		g_hair = hex2num(copytext_char(hex_hair, 4, 6))
		b_hair = hex2num(copytext_char(hex_hair, 6, 8))
		r_facial = hex2num(copytext_char(hex_hair, 2, 4))
		g_facial = hex2num(copytext_char(hex_hair, 4, 6))
		b_facial = hex2num(copytext_char(hex_hair, 6, 8))
		var/hex_eyes = eye_colors[new_eyes]
		r_eyes = hex2num(copytext_char(hex_eyes, 2, 4))
		g_eyes = hex2num(copytext_char(hex_eyes, 4, 6))
		b_eyes = hex2num(copytext_char(hex_eyes, 6, 8))
